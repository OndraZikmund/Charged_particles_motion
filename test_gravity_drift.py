# -*- coding: utf-8 -*-
"""
Created on Sun May 15 02:08:33 2022
...
for w in range(N):
    ...
    field = Field_force(-1,2,3,0,3,2,1,1)  # self, charge,B, dimension, E, directionB, directionE, , G, directionG
    
    Lorentz_force = field.homogenous_magnetic_force(velocity)
    acceleration = Lorentz_force.multiplication_scalar(1/mass)
    acceleration = acceleration.addition(field.homogenous_gravity_force(1).vector)
